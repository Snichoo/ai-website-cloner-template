  ...
  return (
    <div className="relative aspect-square w-full select-none overflow-hidden rounded-2xl">
      ...
      >
        ...
        />
        <span className="absolute left-4 top-4 z-20 rounded-md bg-[#347FCC] px-3 py-1 text-xs font-bold uppercase tracking-wide text-white">
          Before
        </span>
      </div>
      ...
      <div
        ...
        style={{ left: `${pos}%` }}
      >
        <span className="absolute top-1/2 left-1/2 grid size-9 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-white text-[#347FCC] shadow-md">
