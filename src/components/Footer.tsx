  ...
  return (
    <footer className="text-white">
      <div className="bg-[#1e1e1e]">
        <div className="mx-auto grid max-w-[1320px] gap-10 px-6 py-12 md:grid-cols-2 lg:grid-cols-[1.1fr_0.7fr_1.2fr_0.9fr_1.1fr] lg:py-16">
          <div>
      ...
      <div className="bg-[#1e1e1e] pb-12">
        <div className="mx-auto max-w-[1320px] px-6">
          <div className="flex flex-col items-center justify-between gap-6 overflow-hidden rounded-2xl bg-topo-red px-10 py-10 text-center sm:flex-row sm:text-left">
            <h2 className="font-heading text-3xl font-bold uppercase text-white sm:text-4xl">
              We Are Here To Help You
            </h2>
            <Link
              href="/contact"
              className="shrink-0 rounded-md border-2 border-white bg-white px-7 py-2.5 font-heading text-lg font-bold uppercase tracking-wide text-[#347FCC] transition-colors hover:bg-transparent hover:text-white"
            >
              Get a Free Quote
            </Link>
          </div>
