...
/**
 * The standard question set. When a suburb is supplied the location answer is
 * rewritten to lead with that area rather than the generic statewide line.
 */
function baseFaqs(suburbName?: string): FaqItem[] {
  return [
    {
    ...
    },
    {
      ...
      a: `The workshop is open Monday to Friday 8:00am to 5:00pm and Saturday 8:00am to 12:30pm, closed Sunday. We also run a 24/7 emergency callout for breakdowns - if something goes down outside hours, call ${PHONE_DISPLAY}.`,
    },
    {
      q: suburbName
      ...
      a: suburbName
        ? `Yes. Our workshop is at 438-440 Hanson Rd, Wingfield SA 5013, and ${suburbName} is one of the areas we cover regularly - supporting concrete operators, waste and recycling companies, transport fleets, mining and civil contractors and trade businesses. Give us a call on ${PHONE_DISPLAY}.`
        : `We're based at 438-440 Hanson Rd, Wingfield SA 5013 and service Adelaide metro and regional SA and beyond - supporting concrete operators, waste and recycling companies, transport fleets, mining and civil contractors, and trade businesses. Give us a call on ${PHONE_DISPLAY}.`,
    },
    {
      q: "How do I get a quote?",
      a: `Send us the details of your job - drawings or photos help - through our quote form or give us a call on ${PHONE_DISPLAY}. The more detail you give, the faster and more accurate the quote.`,
    },
  ];
}
...
export function Faq({
  ...
  /** Localises the location answer and the heading. */
  suburbName?: string;
  /** Suburb-specific questions, shown first. */
    ...
    <section className="bg-white py-20">
      <div className="mx-auto max-w-[1320px] px-6">
        <Reveal as="h2" className="font-heading text-5xl font-bold uppercase sm:text-6xl">
          {suburbName ? (
            <>
              <span className="text-[#1e1e1e]">Common </span>
              <span className="text-[#347FCC]">{suburbName} Questions</span>
            </>
          ) : (
            <>
