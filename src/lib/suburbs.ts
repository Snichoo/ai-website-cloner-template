...
export const SUBURBS: readonly Suburb[] = [
  {
    ...
    mapQuery: "338-440+Hanson+Rd+Wingfield+SA+5013",
    mapZoom: 14,
    metaTitle:
      "Engineering & Fabrication Wingfield SA | Kingpin Engineering",
    metaDescription:
      "Kingpin Engineering's workshop is at 338-440 Hanson Rd, Wingfield. Concrete agitator drums, skip bins, CNC plasma cutting and heavy repairs, right on your doorstep.",
    ...
    spotlight: {
      ...
      facts: [
        ...
        { label: "Our address", value: "338-440 Hanson Rd" },
    ...
    faqs: [
      {
        ...
        a: "338-440 Hanson Rd, Wingfield SA 5013. Plenty of hardstand for trucks and trailers, and you can drive a loaded rigid straight in. Come between 8am and 5pm on a weekday or 8am to 12:30pm Saturday.",
      },
      {
