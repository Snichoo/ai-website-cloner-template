...
export const SEO_PAGES = {
  ...
  contact: {
    ...
    description: `Call ${PHONE_DISPLAY} or request a fabrication quote. Find Kingpin Engineering at 438-440 Hanson Rd, Wingfield, with workshop hours and emergency callout details.`,
    label: "Contact us",
    type: "ContactPage",
  },
  serviceAreas: {
